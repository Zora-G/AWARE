...
The generated performance figures are produced by the experiment scripts and are
kept out of the README's opening section so the repository front page first
shows the protocol mechanism.
